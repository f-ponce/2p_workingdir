function [value] = qSPV_Int32(c,memType,containerUnit,functionUnit,parameter) 
%   DESCRIPTION
%   
...
%
%   SYNTAX
%        [value] = PIdevice.qSPV_Int32(memType,containerUnit,functionUnit,parameter)
% 
%   INPUT
...
if(any(strcmp(functionName,c.dllfunctions)))
    value =  zeros(1,1);
    value = libpointer('int32Ptr',value);
	try
