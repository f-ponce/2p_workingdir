function [value] = qSPV_Int64(c,memType,containerUnit,functionUnit,parameter) 
%   DESCRIPTION
%   
...
%
%   SYNTAX
%        [value] = PIdevice.qSPV_Int64(memType,containerUnit,functionUnit,parameter)
% 
%   INPUT
...
if(any(strcmp(functionName,c.dllfunctions)))
    value =  zeros(1,1);
    value = libpointer('int64Ptr',value);
	try
