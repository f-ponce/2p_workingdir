function WAV_RAMP(c,WaveTableId, OffsetOfFirstPointInWaveTable, NumberOfPoints, AddAppendWave, CenterPointOfWave,iNumberOfSpeedUpDownPointsInWave, AmplitudeOfWave, OffsetOfWave, SegmentLength)
%   DESCRIPTION
...
%   be defined with a separate call of WAV_RAMP() or one of the other WAV functions. In doing so, the 
...
%
%   SYNTAX
%       PIdevice.WAV_RAMP(WaveTableId, OffsetOfFirstPointInWaveTable, NumberOfPoints, AddAppendWave, CenterPointOfWave,iNumberOfSpeedUpDownPointsInWave, AmplitudeOfWave, OffsetOfWave, SegmentLength)
% 
%   INPUT
%       WaveTableId (int)                               The ID of the wave table
%
%       OffsetOfFirstPointInWaveTable (int)             The index of the starting point of the scan line in the segment. Gives the phase shift. Lowest possible value is 0.
%
%       NumberOfPoints (int)                            The length of the single scan ramp curve as number of points.
%
...
% 
%       CenterPointOfWave (int)                         The index of the center point of the ramp curve. Determines if the curve is symmetrically or not. Lowest possible value is 0.  
%
%       iNumberOfSpeedUpDownPointsInWave (int)          The number of points for speed up and down. 
%
%       AmplitudeOfWave (double)                        The amplitude of the ramp curve. 
%
%       OffsetOfWave (double)                           The offset of the ramp curve. 
%
