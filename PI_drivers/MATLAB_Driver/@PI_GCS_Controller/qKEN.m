function [sAnswer] = qKEN(c, szNamesOfCoordSystems)
%   DESCRIPTION
%   Lists enabled coordinate systems by name.
%
%   SYNTAX
%       [sAnswer] = PIdevice.qKEN(szNamesOfCoordSystems)
% 
%   INPUT
%       szNamesOfCoordSystems (char array)      string with name of the coordinate system. Can be '' to return all
%
%   OUTPUT
