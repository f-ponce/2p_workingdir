function [answer] = qSPV(c,memType,containerUnit,functionUnit,parameter)
%   DESCRIPTION
%   
...
%
%   SYNTAX
%        [answer] = PIdevice.qSPV(memType,containerUnit,functionUnit,parameter)
% 
%   INPUT
...
%
%   OUTPUT
%       [answer] (char array)                Memory for the answer 
%       
...
if(any(strcmp(functionName,c.dllfunctions)))
    answer =  blanks(1000001);
	try
		[bRet,~,~,~,~,answer] = calllib(c.libalias,functionName,c.ID,memType,containerUnit,functionUnit,parameter,answer,1000000);
		if(bRet==0)
			iError = GetError(c);
