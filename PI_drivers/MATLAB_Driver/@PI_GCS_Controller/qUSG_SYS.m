function [usg] = qUSG_SYS(c,chapter)
%   DESCRIPTION
%   
%   Outputs the "SYS" section of the User Guide.
%   The "SYS" section contains information on the structure of the controller.
%    
%
%   SYNTAX
%        [usg] = PIdevice.qUSG_SYS(chapter)
% 
%   INPUT
