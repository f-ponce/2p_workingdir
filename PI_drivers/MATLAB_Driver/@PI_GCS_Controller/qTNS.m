...
%
%   SYNTAX
%       [dOutValues1] = PIdevice.qTNS(iInValues1)
% 
%   INPUT
%       iInValues1 (int array)           array with input signal channels
%
%   OUTPUT
%       [dOutValues1] (double array)     array to receive normalized value (dimensionless)
%      
