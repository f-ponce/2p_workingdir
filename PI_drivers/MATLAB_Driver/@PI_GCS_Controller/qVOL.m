...
%
%   SYNTAX
%       [dOutValues1] = PIdevice.qVOL(iInValues1)
% 
%   INPUT
%       iInValues1 (int array)              array with channels
%
%   OUTPUT
%       [dOutValues1] (double array)        array to be filled with the current voltages for the channels 
%      
