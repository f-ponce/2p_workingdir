...
%   DESCRIPTION
%   Get upper piezo voltage soft limit for piPiezoChannelsArray (iInValues1).  
%
%   SYNTAX
%       [dOutValues1] = PIdevice.qVMA(iInValues1)
% 
%   INPUT
%       iInValues1 (int array)           array with piezo channels
%
%   OUTPUT
%       [dOutValues1] (double array)    array to be filled with the upper limits for the piezo voltage
%      
