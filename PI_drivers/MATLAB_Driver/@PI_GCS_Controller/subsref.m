...
elseif(outsize == 3)
    switch(length(par))
        case 0
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c);
        case 1
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1});
        case 2
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2});
        case 3
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3});
        case 4
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4});
        case 5
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4},par{5});
        case 6
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4},par{5},par{6});
        case 7
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4},par{5},par{6},par{7});
        case 8
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4},par{5},par{6},par{7},par{8});
        case 9
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4},par{5},par{6},par{7},par{8},par{9});
        case 10
            [varargout{1},varargout{2},varargout{3}] = feval(fun,c,par{1},par{2},par{3},par{4},par{5},par{6},par{7},par{8},par{9},par{10});
    end
