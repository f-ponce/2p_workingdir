function FNL(c,szAxes)
%   DESCRIPTION
%   Starts a reference move: Moves all axes szAxes synchronously to the negative physical limits of their 
%   travel ranges and sets the current positions to the negative range limit values.
