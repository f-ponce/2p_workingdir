function [value] = qSPV_UInt64(c,memType,containerUnit,functionUnit,parameter) 
%   DESCRIPTION
%   
...
%
%   SYNTAX
%        [value] = PIdevice.qSPV_UInt64(memType,containerUnit,functionUnit,parameter)
% 
%   INPUT
...
if(any(strcmp(functionName,c.dllfunctions)))
    value =  zeros(1,1);
    value = libpointer('uint64Ptr',value);
	try
