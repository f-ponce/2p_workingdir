...
% motors(1).controllerType = 'Newport ESP301';     % If supplied, one of {'sutter.mp285', 'sutter.mpc200', 'thorlabs.mcm3000', 'thorlabs.mcm5000', 'scientifica', 'pi.e665', 'pi.e816', 'npoint.lc40x', 'bruker.MAMC'}.
...
motors(1).name = 'Motor 1';
motors(1).controllerType = 'Newport ESP301';                 % matches aliases above
motors(1).dimensions = '---';                    % or 'Z--' if only Z
motors(1).customArgs = [];
